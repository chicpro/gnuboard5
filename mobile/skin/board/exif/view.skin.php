...
include_once($board_skin_path.'/exif.lib.php');
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
        ...
        if($v_img_count) {
            ...
            for ($i=0; $i<=count($view['file']); $i++) {
                if ($view['file'][$i]['view']) {
                    ...
                    echo get_view_thumbnail_exif($view['file'][$i]['view']);
                }
            }
        ...
        <div id="bo_v_con"><?php echo get_view_thumbnail_exif($view['content']); ?></div>
